...
if($con)
{
	...
	$query = "insert into breath_insident(recovery_position, transported, sensations, contacts_id) values('".$RecoveryPosition."', '".$Transported."', '".$Sensations."', '".$ContactId."');";
